...
export const MSG = {
    conversations: {
        ...
        chooseMemberToAddTag: (title: string) => `Вибери користувачів яких хочеш додати до щойно створеного тегу <b>${title}</b>.`,
        tagCreated: 'Тег успішно створено!',
    },
    menu: {
        text: {
            selectActions: (tag: ITag) => `Обери яку дію бажаєш виконати з тегом.\n\nІнформація про тег:\n\nНазва тегу: <b>${tag.title}</b>\nСимвольний тег: <b>${tag.tag}</b>\nКількість користувачів: <b>${tag.members?.length || 0}</b>`,
            ...
            setupTag: (group: IGroup) => `Обери яку дію бажаєш виконати в групі.\n\nІнформація про групу:\n\nНазва групи: <b>${group.title}</b>\nТип групи: <b>${group.type}</b>\nКількість тегів: <b>${group.tags?.length || 0}</b>`,
            addAdmin: 'Вибери кому дати роль адміна',
            removeAdmin: 'Вибери у кого забрати роль адміна',
            chooseGroupToUpdate: 'Вибери групу для якої потрібно створити/оновити/видалити теги.',
            ...
            selsectUserToRemove: 'Вибери користувача якого хочеш видалити з тегу.',
        },
        buttons: {
            setupAdmins: 'Адміни',
