...
export const MSG = {
    ...
    groups: {
        greetings: {
            ...
            dynamic: ['Прокинулися, сплюшки? 😴 Час відкривати очі та вирушати у світ новин!🫡', 'Хей-хей! 👋 Чи готові до нової порції новин із нашою ранковою бандою?🐙', 'Доброго ранку! Час розпочати цей день з новинами про ваші улюблені ігри! 🎮📝', 'Ранковий привіт! Заправляйте свої кавові чашки та готуйтеся до порції гарячих новин! ☀️☕️']
        },
    },
    menu: {
        text: {
